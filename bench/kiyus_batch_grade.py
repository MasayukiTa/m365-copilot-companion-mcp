#!/usr/bin/env python3
"""Runs ON kiyus (inside the Ubuntu WSL). Grades a WHOLE predictions file with swebench's
...
compact result + a .done marker to the Windows-shared verdicts dir for the caller to scp back.
    ...
    python3 kiyus_batch_grade.py <predictions.json> <run_id> <max_workers> [dataset_name]
"""
import glob
import json
import os
