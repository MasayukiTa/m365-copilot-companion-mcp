...
| grade on a clean host (swebench, any dataset) | `bench/swe_grade_swebench.py` + `the eval host_batch_grade.py` |
...
L1 over the existing fleet + the eval host grade, with guards #1–#5 implemented and the 2026-06-21 Verified
