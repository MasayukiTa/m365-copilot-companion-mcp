...
- the grader (`bench/swe_grade_swebench.py`, `kiyus_batch_grade.py`) and the swebench harness on kiyus
...
Enforcement (not just convention): grading runs on a separate host (kiyus) the solver cannot reach;
