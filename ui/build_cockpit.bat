...
"%CSC%" /nologo /target:winexe /win32manifest:"%~dp0app.manifest" /out:"%~dp0FleetCockpit.exe" /r:"%WPF%\PresentationFramework.dll" /r:"%WPF%\PresentationCore.dll" /r:"%WPF%\WindowsBase.dll" /r:"%FW%\System.Xaml.dll" /r:"%FW%\System.Web.Extensions.dll" /r:"%FW%\System.Windows.Forms.dll" "%~dp0FleetCockpit.cs" "%~dp0SelfImproveDashboard.cs"
