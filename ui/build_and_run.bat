...
"%CSC%" /nologo /target:winexe /out:"%~dp0CopilotChat.exe" /r:"%WPF%\PresentationFramework.dll" /r:"%WPF%\PresentationCore.dll" /r:"%WPF%\WindowsBase.dll" /r:"%XAML%" "%~dp0CopilotChat.cs" "%~dp0Markdown.cs"
