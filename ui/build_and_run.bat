...
"%CSC%" /nologo /target:winexe /out:"%~dp0CopilotChat.exe" /r:"%WPF%\PresentationFramework.dll" /r:"%WPF%\PresentationCore.dll" /r:"%WPF%\WindowsBase.dll" /r:"%XAML%" /r:"%WEBEXT%" "%~dp0CopilotChat.cs" "%~dp0Markdown.cs"
