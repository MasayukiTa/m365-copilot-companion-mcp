...
Chain (kiyus bot has NO key on its side -- exfiltration guard forbids sending
MCP_API_KEY to kiyus, so the key stays HERE and this proxy injects it):

    kiyus bot -> kiyus 127.0.0.1:8012 --[ssh -R reverse tunnel]-->
    M118A8586 127.0.0.1:8012 (THIS proxy, adds Authorization: Bearer <MCP_API_KEY>)
